        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <b-button variant="outline-primary" size="sm" @click=onPrint>Print</b-button>
                    <b-button variant="outline-primary" size="sm" @click="newModal">Add New</b-button>
                    <b-modal id="filter-modal" ref="filter" title="Filter" hide-footer>
                        <b-form @submit.stop.prevent="onFilterSubmit">
                            ...
                            <b-form-group label="Store:" v-if="user.role==3">
                                <b-form-select
                                    v-model="filterForm.store" :options="stores" value-field="id" text-field="name">
            ...
            <div class="card" id="printMe">
                <div class="card-header">
                    <p class="card-title">
                        Expenditures  from {{ filterForm.start_date | myDate }} to {{ filterForm.end_date | myDate }}
                    </p>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                axios.get("/api/account/expenditure?page=" + page).then(response => {
            ...
            loadAccount() {
                ...
                axios.get("/api/account/expenditure", { params: this.filterForm })
                .then(({ data }) => {
            ...
            createAccount() {
                ...
                axios.post("/api/account/expenditure", this.form)
                .then(() => {
                    Swal.fire(
                        "Created!",
            ...
            deleteAccount(id) {
                ...
                .then(result => {
                    if (result.value) {
                        this.$Progress.start();
                        this.form.delete("/api/account/expenditure/" + id)
                        .then(() => {
                            Swal.fire(
                                "Deleted!",
